// Deployability policy v1 (§8.15, §11.8): a filter and explanation layer,
// never a hidden multiplier on rank. Returns eligibility plus a reason
// vector so every exclusion is explainable.
export const DEPLOYABILITY_POLICY_VERSION = "deployability-v1"
...
/** Default policy: public source, an install recipe, and a known license. */
